      ...
      <div class="box-hd">
        ...
        <div class="more clearfix">
          <ul class="filter-list J_orderType">
            <li class="first ${type eq 1 ? 'active':''}"><a href="${ctx}/uc/order/list?type=1" data-type="1">全部有效订单</a></li>
            <li class="${type eq 2 ? 'active':''}"><a id="J_unpaidTab" href="${ctx}/uc/order/list?type=2" data-type="2">待支付</a></li>
            <li class="${type eq 3 ? 'active':''}"><a id="J_sendTab" href="${ctx}/uc/order/list?type=3" data-type="3">待收货</a></li>
            <li class="${type eq 4 ? 'active':''}"><a href="${ctx}/uc/order/list?type=4" data-type="4">已关闭</a></li>
          </ul>
        ...
        <div id="J_orderList">
          <ul class="order-list">
            <c:forEach items="${orderVOs}" var="orderVO">
                      ...
                      <thead>
                        <tr>
                          <th class="col-main"> <p class="caption-info">
                              ...
                              <span class="sep">|</span>${orderVO.orderShipmentUserName}<span class="sep">|</span>订单号： <a href="${ctx}/uc/order/${orderVO.orderNumber}">${orderVO.orderNumber}</a><span class="sep">|</span>在线支付</p>
                          </th>
                ...
                <li class="uc-order-item uc-order-item-shipping">
                  <div class="order-detail">
                    <div class="order-summary">
                      ...
                      <p class="order-desc J_deliverDesc"> 我们将尽快为您配送 </p>
                    </div>
                    <table class="order-detail-table">
                      <thead>
                      <tr>
              ...
              <c:if test="${orderVO.orderStatus eq 9 || orderVO.orderStatus eq 10}">
                <li class="uc-order-item uc-order-item-finish">
                  <div class="order-detail">
                    <div class="order-summary">
