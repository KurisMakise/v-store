...
<div class="goods-comment">
  <div class="goods-comment-groom" id="J_recommendComment" style="display:${productAttrVO.commentNumber eq 0?'none':'black'}">
  ...
  <div class="goods-comment-order-block" id="J_commentOrder">
    <div class="container-fluid">
      <div class="row">
        <div class="span14">
          <div class="left-title J_commentOrder"> <a href="${ctx}/comment/list?productNumber=${productVO.productNumber}&sort=1" class="${sort eq 1 ? 'current':''} J_helpOrder">最有帮助的评价</a> <span class="sep">|</span> <a href="${ctx}/comment/list?productId=${productVO.productId}&sort=0"  class="${sort eq 0 ? 'current':''}">最新的评价</a> </div>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="span14 goods-comment-list-detail">
          ...
          <div class="goods-detail-null-content" style="display:${empty commentVOPage.records ? 'block':'none'}" id="J_commentTipInfo">
            <h3>暂时还没有更多评价</h3>
            <p>期待你分享科技带来的乐趣</p>
          </div>
          <div class="comment-page-nav-list" id="J_commentPagenav">
            <c:if test="${commentVOPage.total gt commentVOPage.size and not empty commentVOPage.records}">
              <div id="pager" data-pager-href="${ctx}/comment/list?productId=${productVO.productId}&sort=${sort}&page=" data-pager-totalPage="${totalPage}" data-pager-current="${commentVOPage.current}"></div>
            </c:if>
          </div>
        </div>
        <div class="span6 goods-detail-info-block">
          <div class="goods-detail-info">
            <div class="goods-img-block"> <a target="_blank" href="${ctx}/item/${productVO.productId}" title="${productVO.name}"> <img src="${ctximg}/${productVO.picImg}" class="J_cartBigImg" alt="${productVO.name}"> </a> </div>
